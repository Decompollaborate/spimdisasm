...
class ContextSymbolBase:
    ...
    def toCsv(self) -> str:
        return f"{self.name},{self.getType()},0x{self.size:X},{self.isUserDefined},{self.isDefined},{self.isStatic},{self.sectionType.toStr()},{self.isLateRodata},{self.isMaybeString},{self.isAutogenerated},{self.referenceCounter}"
...
class ContextSymbol(ContextSymbolBase):
    ...
    def toCsv(self) -> str:
        return f"0x{self.vram:08X}," + super().toCsv()
...
class ContextOffsetSymbol(ContextSymbolBase):
    ...
    def toCsv(self) -> str:
        return f"0x{self.offset:06X}," + super().toCsv()
...
class ContextRelocSymbol(ContextSymbolBase):
    ...
    def toCsv(self) -> str:
        return f"0x{self.offset:06X}," + super().toCsv() + f",{self.relocSection.toStr()},{self.relocType}"
