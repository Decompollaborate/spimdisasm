...
class GlobalConfig:
    ...
    def addParametersToArgParse(parser: argparse.ArgumentParser):
        ...
        backendConfig.add_argument("--not-filter-low-addresses", help="Treat low addresses (lower than 0x40000000) as real pointers", action="store_true")
        backendConfig.add_argument("--not-filter-high-addresses", help="Treat high addresses (higher than 0xC0000000) as real pointers", action="store_true")
    ...
    def parseArgs(cls, args: argparse.Namespace):
        ...
        GlobalConfig.SYMBOL_FINDER_FILTER_LOW_ADDRESSES = not args.not_filter_low_addresses
        GlobalConfig.SYMBOL_FINDER_FILTER_HIGH_ADDRESSES = not args.not_filter_high_addresses
