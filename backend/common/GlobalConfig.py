...
class GlobalConfig:
    ...
    def addParametersToArgParse(parser: argparse.ArgumentParser):
        ...
        backendConfig.add_argument("--no-filtered-addresses-as-constants", help="Stop treating filtered out addressed as constants", action="store_true")
    ...
    def parseArgs(cls, args: argparse.Namespace):
        ...
        GlobalConfig.SYMBOL_FINDER_FILTERED_ADDRESSES_AS_CONSTANTS = not args.no_filtered_addresses_as_constants
