...
class SectionData(SectionBase):
        ...
        for w in self.words:
            ...
            if relocInfo is not None:
                if relocInfo.vram is not None:
                    ...
                    sectionType = relocInfo.referencedSection or common.FileSectionType.Unknown
                    self.addSymbol(relocVram, sectionType=sectionType, isAutogenerated=True)
            vram += 4
    ...
    def analyze(self):
        ...
        for w in self.words:
            ...
            if w >= self.context.totalVramStart and w < self.context.totalVramEnd:
