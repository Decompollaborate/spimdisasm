...
class SymbolFunction(SymbolText):
    ...
    def analyze(self):
        ...
        for gotAccessOffset, gotAccess in self.instrAnalyzer.gotAccessAddresses.items():
            ...
            symAccess = self.instrAnalyzer.possibleSymbolTypes.get(gotAccess)
            if symAccess is not None and inGlobalTable:
                self.instrAnalyzer.possibleSymbolTypes[gotAddress] = symAccess
