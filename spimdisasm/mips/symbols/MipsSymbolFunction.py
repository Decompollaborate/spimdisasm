    ...
    def analyze(self):
        ...
        for gotAccessOffset, gotAccess in self.instrAnalyzer.gotAccessAddresses.items():
            ...
            if gotAddress is None or inGlobalTable is None:
                continue
            print(f"{gotAccessOffset:06X} {gotAccessOffset + self.inFileOffset + self.commentOffset:06X} {gotAccess:08X} {gotAddress:08X}", end="")
            if inGlobalTable:
                ...
                loOffset = self.instrAnalyzer.hiToLowDict[gotAccessOffset]
