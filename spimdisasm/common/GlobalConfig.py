...
class GlobalConfigType:
    ...
    OUTPUT_UNDECODED_STRINGS: bool = False
    ...
    def addParametersToArgParse(self, parser: argparse.ArgumentParser):
        ...
        backendConfig.add_argument("--output-undecoded-strings", help=f"Output raw bytes instead of decoded strings. Defaults to {self.OUTPUT_UNDECODED_STRINGS}", action=Utils.BooleanOptionalAction)
...
"""
    ...
    def parseArgs(self, args: argparse.Namespace):
        ...
        if args.output_undecoded_strings is not None:
            self.OUTPUT_UNDECODED_STRINGS = args.output_undecoded_strings
