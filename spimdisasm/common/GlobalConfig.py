...
class GlobalConfigType:
    ...
    SEQUENTIAL_BRANCH_LABEL_NAMES: bool = False
    """Name branch labels after their containing function and a sequential number"""
    SEQUENTIAL_JUMP_TABLE_NAMES: bool = False
    """Name jump tables after their containing function and a sequential number"""
...
"""
        ...
        backendConfig.add_argument("--sequential-branch-label-names", help=f"Toggles naming branch labels after their containing function and a sequential number. Defaults to {self.SEQUENTIAL_BRANCH_LABEL_NAMES}", action=Utils.BooleanOptionalAction)
        backendConfig.add_argument("--sequential-jump-table-names", help=f"Toggles naming jump tables after their containing function and a sequential number. Defaults to {self.SEQUENTIAL_JUMP_TABLE_NAMES}", action=Utils.BooleanOptionalAction)
    ...
    def parseArgs(self, args: argparse.Namespace):
        ...
        if args.sequential_branch_label_names is not None:
            self.SEQUENTIAL_BRANCH_LABEL_NAMES = args.sequential_branch_label_names
        if args.sequential_jump_table_names is not None:
            self.SEQUENTIAL_JUMP_TABLE_NAMES = args.sequential_jump_table_names
