...
class GlobalConfigType:
    ...
    SEQUENTIAL_BRANCH_LABELS: bool = False
...
"""
        ...
        backendConfig.add_argument("--sequential-branch-labels", help=f"Toggles naming branch labels after their containing function and a sequential number. Defaults to {self.SEQUENTIAL_BRANCH_LABELS}", action=Utils.BooleanOptionalAction)
    ...
    def parseArgs(self, args: argparse.Namespace):
        ...
        if args.sequential_branch_labels is not None:
            self.SEQUENTIAL_BRANCH_LABELS = args.sequential_branch_labels
