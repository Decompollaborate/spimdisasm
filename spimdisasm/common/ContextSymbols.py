...
SymType = SymbolSpecialType|str|None
...
class ContextSymbol:
    ...
    userDeclaredType: SymType = None
    autodetectedType: SymType = None
    ...
    #! @deprecated
    @property
    def type(self) -> SymType:
        return self.getTypeSpecial()

    #! @deprecated
    @type.setter
    def type(self, value: SymType):
    ...
    def _defaultName_uniqueIdentifier(self, symType: SymType) -> str:
    ...
    def _defaultName_sectionPrefix(self, symType: SymType) -> str:
    ...
    def _defaultName_typePrefix(self, symType: SymType) -> str:
    ...
    def getTypeSpecial(self) -> SymType:
    ...
    def setTypeSpecial(self, newType: SymType, isAutogenerated: bool):
        if isAutogenerated:
            self.autodetectedType = newType
        else:
            self.userDeclaredType = newType

    def setTypeIfUnset(self, newType: SymType, isAutogenerated: bool) -> bool:
        if self.hasNoType():
