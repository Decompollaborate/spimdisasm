...
class ContextSymbol:
    ...
    def getCsvHeader() -> str:
        ...
        output += "isGot,isGotGlobal,isGotLocal,gotIndex,isAutogeneratedPad"
        return output
    ...
    def toCsv(self) -> str:
        ...
        output += f"{self.isGot},{self.isGotGlobal},{self.isGotLocal},{self.gotIndex},{self.isAutogeneratedPad()}"
        return output
