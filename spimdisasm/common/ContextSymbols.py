...
class ContextSymbol:
    ...
    def getSymbolLabel(self) -> str:
        ...
        if GlobalConfig.ASM_COMMENT:
            ...
            if self.isAutoCreatedPad and self.referenceCounter == 0 and self.isAutogenerated:
    ...
    def getCsvHeader() -> str:
        ...
        output += "isGot,isGotGlobal,isGotLocal,gotIndex,isAutoCreatedPad"
        return output
    ...
    def toCsv(self) -> str:
        ...
        output += f"{self.isGot},{self.isGotGlobal},{self.isGotLocal},{self.gotIndex},{self.isAutoCreatedPad}"
        return output
