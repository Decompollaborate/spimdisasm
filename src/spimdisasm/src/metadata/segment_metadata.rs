...
#[cfg(feature="nightly")]
fn add_symbol_impl(slf: &mut SegmentMetadata, vram: Vram, autogenerated: bool, allow_sym_with_addend: bool) -> &mut SymbolMetadata {
...
mod tests {
    ...
    fn check_symbol_bounds() {
        ...
        segment.add_symbol(Vram::new(0x100C), None, true, None, true);
