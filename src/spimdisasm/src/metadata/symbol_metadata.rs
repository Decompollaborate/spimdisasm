...
use rabbitizer::{vram::VramOffset, Vram, access_type::AccessType};
...
pub struct SymbolMetadata {
    ...
    // TODO: Should sizes be its own type instead of `VramOffset`.
    user_declared_size: Option<VramOffset>,
    autodetected_size: Option<VramOffset>,
...
impl SymbolMetadata {
    ...
    pub fn autodetected_size(&self) -> Option<VramOffset> {
